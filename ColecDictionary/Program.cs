...
//fijando los nombre de los departamentos con mayor y menor poblacion 
string minDepkey = ordenado.First().Key;
string maxDepkey = ordenado.Last().Key;
//reasignacion de ,os arreglos en paralelo
Departamento = ordenado.Keys.ToArray();
Poblacion = ordenado.Values.ToArray();
//Mostrar los areglos odenados de menor a mayor
